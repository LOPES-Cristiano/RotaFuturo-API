...
/**
 * Classe utilitaria para funcoes comuns de aplicacao. como obter a data
 * atual,validar emails, normalizar strings, etc.
 */
public final class AppUtils {
	...
	/**
	 * Retorna um valor de um Optional, ou um valor padrao se o Optional estiver
	 * vazio.
	 * 
