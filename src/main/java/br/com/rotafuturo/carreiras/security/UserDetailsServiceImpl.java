...
/**
 * Implementacao do UserDetailsService do Spring Security. Carrega os detalhes
 * do usuario do banco de dados para autenticacao.
 * 
 * Aqui é para validar o usuário no login, ele procura se tem algum usuário com
 * esse email. Se encontrar, retorna os detalhes do usuário, caso contrário,
 * lança uma exceção.
 */
@Service
