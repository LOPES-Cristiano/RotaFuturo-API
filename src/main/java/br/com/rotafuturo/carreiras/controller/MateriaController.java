...
public class MateriaController {
    ...
    public ResponseEntity<br.com.rotafuturo.carreiras.dto.MateriaDTO> getById(@PathVariable Integer id) {
        ...
        return materia.map(m -> ResponseEntity.ok(materiaService.toDTO(m))).orElseGet(() -> ResponseEntity.notFound().build());
    }

    @PostMapping
    public ResponseEntity<br.com.rotafuturo.carreiras.dto.MateriaDTO> create(@RequestBody br.com.rotafuturo.carreiras.dto.MateriaDTO materiaDTO) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<br.com.rotafuturo.carreiras.dto.MateriaDTO> update(@PathVariable Integer id, @RequestBody br.com.rotafuturo.carreiras.dto.MateriaDTO materiaDTO) {
